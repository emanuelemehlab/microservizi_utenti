...
public interface TassistaRepository extends JpaRepository<Tassista, String> {
    ...
    @Query("SELECT tas.email,tas.nome,tas.cognome,d.disponibilita,a.targa,a.descrizione,a.nPosti,a.bagagliaio,a.seggiolino FROM Tassista AS tas, Disponibilita AS d, Automobile AS a  WHERE  tas.email=d.email AND d.email=a.tassista.email AND tas.email IN ?1")
